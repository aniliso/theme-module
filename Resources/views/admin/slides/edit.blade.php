...
@section('content-header')
    <h1>
        {{ trans('theme::slides.title.edit slide') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.theme.slide.index') }}">{{ trans('theme::slides.title.slides') }}</a></li>
        <li class="active">{{ trans('theme::slides.title.edit slide') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.theme.slide.update', $slide->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                @include('theme::admin.slides.partials.edit-fields')
